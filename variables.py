...
class Variables:
    ...
    def __get_title(self):
        return self.post.find('div', class_='entry unvoted').div.p.text.split('(')[utils['MAGIC_ZERO']]\
        .replace("'", "")[0:utils['MAGIC_THREE']]
    ...
    def __get_domain_tag(self):
        titles = self.post.find('p', class_='title').replace("'", "")
    ...
    def __set_dtypes(self):
        ...
        self.UNKNOWN_DICT = {'postid': self.__get_postid,
                             ...
                             'author_info': self.__get_author_info}
